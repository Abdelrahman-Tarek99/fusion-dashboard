...
import { useIsMobile } from "@/common/components/ui/hooks/use-mobile";
...
function Sidebar({
  ...
  // Automatically flip the side in RTL mode
  const effectiveSide =
  ...
  return (
    <div
      ...
      data-slot="sidebar"
    >
      {/* Update the sidebar gap div classes */}
      <div
      ...
      />
      {/* Update the sidebar container div classes */}
      <div
...
function SidebarTrigger({
  ...
  const { toggleSidebar, dir } = useSidebar();
  ...
  return (
    <Button
      ...
      variant="ghost"
      size="icon"
      className={cn("size-7", dir === "rtl" && "rotate-180", className)}
      onClick={(event) => {
        onClick?.(event);
        toggleSidebar();
      }}
